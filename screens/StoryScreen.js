...
export default class StoryScreen extends Component {
  ...
  async initiateTTS (title,author,title,moral){
    const speaker_Color = this.state.speakerColor
    this.setState({ speakerColor: current_color === "gray" ? "#ee8249" : "gray" });o
    if (current_color === "gray") { Speech.speak(`${title} by ${author}`); Speech.speak(story); 
    Speech.speak("The moral of the story is!"); Speech.speak(moral); } 
    else { Speech.stop(); }
